...
$(document).ready(function(){
  ...
  $('#add_row').click(function(){
    ...
    table_row += "<td contenteditable='true' class='med_name'></td>";
    table_row += "<td contenteditable='true' class='med_qty'></td>";
    table_row += "<td contenteditable='true' class='med_dos'></td>";
    table_row += "<td><button type='button' data-row='row" + count + "' class='btn btn-danger btn-sm remove'>remove row</button></td>";
    table_row += "</tr>";
