  ...
  <div class="content-wrapper">
    <div class="container-fluid">
      ...
      if (isset($_GET['lab_results'])) {
        ...
        $sql = mysqli_query($con, "SELECT * FROM lab_results INNER JOIN patient ON lab_results.patient_id = patient.patient_id WHERE patient.patient_id = '$id' AND lab_results.status = 0 ORDER BY lab_results.id DESC LIMIT 1");
